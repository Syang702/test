...
<template>
    <view class="datepicker">
        <view class="datepicker-toolbar">
            <view class="datepicker-toolbar_button" @tap="changeMode">{{text}}
        ...
        <view class="datepicker-box" v-if="mode=== 1">
            ...
            <view class="datepicker-header__calendar">
                <picker-view v-if="monthPicker.visible" class="datepicker-header__calendar-picker" indicator-class="picker-selected" :value="monthPicker.value"
        ...
        <view v-if="mode === 0" class="datepicker-box">
            ...
            <view class="datepicker-header__calendar">
                <picker-view v-if="dayPicker.visible" class="datepicker-header__calendar-picker" indicator-class="picker-selected" :value="dayPicker.value"
