/* 滑块验证 */
<template>
    <view class="zhezhao" v-if="shows" @click="shows=false">
        <view class="verifyBox" @touchend="onEnd">
            <view class="pintuBox">
                <image :src="'../../static/images/index/verify'+img+'.jpg'" class="pintuBg"></image>
            </view>
                ...
                <movable-area :animation="true">
                    <movable-view :x="x" direction="horizontal" @change="onMove">
                        <view class="pintukuai" :style="{top:top+'px'}">
                            <image :src="'../../static/images/index/verify'+img+'.jpg'" :style="{top:-lefttop+'px',left:-left+'px'}"></image>
                        </view>
                    </movable-view>
                </movable-area>
...
.huakuaiBox movable-area movable-view {
    ...
    background-image: url(../../static/images/index/verify-slide.png);
