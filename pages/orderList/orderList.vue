	...
	<view class="shoplist">
		<view class="shoplist-box">
			...
			<view class="shoplist-box-list-box">
				<view class="shoplist-box-list-box-list" v-for="(item, index) in orderList" :key="index">
					<view class="shoplist-box-list-box-list-left"><image :src="item.url"></image></view>
					<view class="shoplist-box-list-box-list-right">
						...
						<view class="shoplist-box-list-box-list-right-bottom">单价：￥{{ item.price }} 数量：{{ item.number }}</view>
					</view>
				</view>
			</view>
		</view>
