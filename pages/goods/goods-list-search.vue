...
<script>
import { getSearchedGoodsList } from '../../config/api.js'
export default {
    data() {
        return {
    ...
    onLoad(param) {
        ...
        this.queryList.searchKeyWord = "";
		if(param.keyword!=undefined && param.keyword.trim()!=""){
			this.keyword = param.keyword.trim();
		}
    ...
    methods: {
        getGoodsList() {
            ...
            getSearchedGoodsList(this.queryList).then(res => {
				var tempGoodsList = []
