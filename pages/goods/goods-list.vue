...
<script>
import { getClassifyGoodsList } from '../../config/api.js'
export default {
    data() {
        return {
    ...
    components: {},
    onLoad(e) {
        this.queryList.cateType2 = JSON.parse(e.params).pId
        this.queryList.cateType3 = JSON.parse(e.params).id
        this.getGoodsList()
    },
    watch: {
    ...
    methods: {
        getGoodsList() {
            getClassifyGoodsList(this.queryList).then(res => {
				var tempGoodsList = []
