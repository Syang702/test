<template>
    <div>
        ...
        <div style="margin-top: 10px">
            <el-table :data="salaries" border v-loading.fullscreen.lock="loading" element-loading-spinner="fa fa-spinner fa-pulse fa-3x fa-fw" stripe>
            ...
            <el-dialog title="套账修改" :visible.sync="updatedialogVisible" width="70%" size="mini" :before-close="handleClose">
                <el-form ref="empform" :model="salary" label-width="120px" size="120" :rules="rules">
                    <el-row :gutter="10">
                        <el-col :span="6">
                            <el-form-item prop="name" label="账套名称">
                    ...
                    <el-row :gutter="10">
                        ...
                        <el-col :span="6">
                            <el-button @click="updatedialogVisible = false" style="margin-left: 120px">取 消</el-button>
