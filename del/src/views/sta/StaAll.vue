    ...
    <div>
        <div style="margin-top:30px;display:flex ;justify-content: center;">
            <div style="width:1500px">
                <el-carousel indicator-position="outside" height="740px" style="overflow-y: hidden;padding-bottom:30px;">
                    <el-carousel-item v-for="(item, index) in datas" :key="index" style="">
                        <ve-line :data="item.chartData" :settings="item.chartSettings" height="700px" width="100%" :judge-width="true"></ve-line>
                    </el-carousel-item>
                </el-carousel>
            </div>
        </div>
