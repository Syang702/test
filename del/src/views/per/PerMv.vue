    ...
    <div>
        <div class="top-style">
            ...
            <div style="display: flex;justify-content: flex-end">
                <!--add 弹窗-->
                <el-dialog title="员工调动" center :visible.sync="dialogVisible" width="30%">
                    <div>
                        <el-form :model="emp" :rules="rules" ref="empForm">
                            <el-form-item label="调动职称:" prop="posid">
                                <el-select v-model="emp.joblevelid" placeholder="职位" style="width: 150px;">
                                    <el-option v-for="item in joblevels" :key="item.id" :label="item.name" :value="item.id"> </el-option>
                                </el-select>
                            </el-form-item>
                            <el-form-item label="调动部门:" prop="departmentid">
                    ...
                    >
                        <el-table-column type="expand">
                            <template slot-scope="props">
                                <el-table :data="props.row.employeeremoveList" style="width: 100%" :row-class-name="tableRowClassName">
                                    <el-table-column prop="department.name" label="调动部门" width="180"> </el-table-column>
                                    <el-table-column prop="jobLevel.name" label="调动职称" width="180"> </el-table-column>
                        ...
                        <el-table-column prop="engageform" align="left" label="聘用形式"> </el-table-column>
                        <el-table-column prop="begindate" align="left" label="入职日期"> </el-table-column>

                        <el-table-column prop="begincontract" align="left" label="合同起始日期"> </el-table-column>
                        <el-table-column prop="endcontract" align="left" label="合同截止日期"> </el-table-column>
                        <el-table-column align="left" label="合同期限">
                        ...
                        <el-table-column width="200" align="center" label="操作">
                            <template slot-scope="scope">
                                <el-button type="primary" @click="showEditEmpView(scope.row)" style="padding: 3px">调 动 </el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
