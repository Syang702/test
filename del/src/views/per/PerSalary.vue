    ...
    <div>
        <div class="top-style">
            ...
            <div style="display: flex;justify-content: flex-end">
                <!--add 弹窗-->
                <el-dialog title="员工调动" :visible.sync="dialogVisible" width="40%">
                    <div>
                        <el-form :model="emp" :rules="rules" ref="empForm">
                            <el-row>
                                <el-col :span="6">
                                    <el-form-item label="调动后职位:" prop="posid">
                                ...
                                <el-col :span="6">
                                    <el-form-item label="调动后部门:" prop="departmentid">
                ...
                <div>
                    ...
                    >
                        ...
                        <el-table-column width="200" label="操作">
                            <template slot-scope="scope">
                                <el-button type="primary" @click="showEditEmpView(scope.row)" style="padding: 3px">调动 </el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
